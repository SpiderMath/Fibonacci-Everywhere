...
-- This is the wait function, so uncomment the following code as well
-- function Wait( second )
-- 	local start = os.time()
-- 	repeat until os.time() > start + second
-- end

PreviousFibonacci1 = BigNum.new(1)
PreviousFibonacci2 = BigNum.new(0)

while true do
	-- Uncomment this code, if you want a timeout to the generated numbers.takes in Seconds
	-- Wait(1)
	CurrentFibonacci = BigNum.new(0)
	BigNum.add(PreviousFibonacci1, PreviousFibonacci2, CurrentFibonacci)

	print(BigNum.mt.tostring(CurrentFibonacci))
	print("")
